...
const PolicyChangeProfilePhoto = () => {
  return (
    ...
    //  mr:'-100px'
     ...
     <Typography sx={{ fontSize: "20px", fontWeight: 700, m: "20px" }}>
         Change Profile Picture
          ...
          <Box sx={{m:'20px'}}>
            <Typography sx={{fontWeight:600, fontSize:'14px', mb:'10px'}}>Upload Image</Typography>
           <CustomTextField sx={{mb:'20px'}}  type='file'/>
...
export default PolicyChangeProfilePhoto