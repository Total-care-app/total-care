...
const StockistRequestedProduct = () => {
      ...
      >
        <Box sx={{ width: "75vw", mt: "30px", }}>
          <Typography sx={{ fontSize: "20px", fontWeight: 700, m: "20px" }}>
            Franchise Member Request order List
          </Typography>
<Divider/>
          <Box
            sx={{
          ...
          >
            ...
            >
              <TableRow>
                ...
                <StyledTableCell align="left">Franchise</StyledTableCell>
                ...
                <StyledTableCell align="left">Proof of Payment</StyledTableCell>
...
export default StockistRequestedProduct;
