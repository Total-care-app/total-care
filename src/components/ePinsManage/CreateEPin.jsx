    ...
    //  mr:'-100px'
     ...
     <Typography sx={{ fontSize: "20px", fontWeight: 700, m: "20px" }}>
         Create E Pin
          ...
          <Box sx={{m:'20px'}}>
            <Typography sx={{fontWeight:600, fontSize:'14px', mb:'10px'}}>Package</Typography>
           <DropDown data={data} />
          </Box>
          <Box sx={{m:'20px'}}>
            <Typography sx={{fontWeight:600, fontSize:'14px', mb:'10px'}}>No of Pins</Typography>
           <CustomTextField/>
          </Box>
          <Box sx={{m:'20px'}}>
            <Typography sx={{fontWeight:600, fontSize:'14px', mb:'10px'}}>User Id</Typography>
           <CustomTextField sx={{mb:'20px'}} placeholder='Enter User ID'/>
