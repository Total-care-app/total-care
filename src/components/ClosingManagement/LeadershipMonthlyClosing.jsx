...
const LeadershipMonthlyClosing = () => {
  ...
  return (
    <Grid item xs={6} md={3} sx={{ml:"20px", mt:'40px'}}>
      ...
      >
         <Box sx={{m:'20px', width:'300px'}}>
            <Typography sx={{fontWeight:600, fontSize:'14px', mb:'10px'}}>Date</Typography>
           <CustomTextField sx={{mb:'20px'}} type="date"/>

           <MainButton width="150px" text="Submit"/>
          </Box>
        <Box sx={{ width: "75vw", mt: "30px", }}>
          <Typography sx={{ fontSize: "20px", fontWeight: 700, m: "20px" }}>
          Leadership Monthly Closing Report
          </Typography>
<Divider/>
          <Box
            sx={{
          ...
          >
            ...
            >
              <TableRow>
                ...
                <StyledTableCell align="left">Leadership Self Bonus</StyledTableCell>
                <StyledTableCell align="left">Leadership Bonus</StyledTableCell>
...
export default LeadershipMonthlyClosing;
