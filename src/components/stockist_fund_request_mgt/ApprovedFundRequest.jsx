      ...
      >
        <Box sx={{ width: "75vw", mt: "30px", }}>
          <Typography sx={{ fontSize: "20px", fontWeight: 700, m: "20px" }}>
            Stockist Approved Fund Request
          </Typography>
<Divider/>
          <Box
            sx={{
          ...
          >
            ...
            >
              <TableRow>
                ...
                <StyledTableCell align="left">Stockist ID</StyledTableCell>
                <StyledTableCell align="left">Stockist Member Name</StyledTableCell>
                ...
                <StyledTableCell align="left">Transaction Number</StyledTableCell>
